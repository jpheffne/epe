...
read_study3 <- TRUE # if you want to load study 3 dynamic data make TRUE 
...
t.test(figS4a_test$bic[figS4a_test$model == "m2c"], figS4a_test$bic[figS4a_test$model == "m2b"], paired = T)

figS4a_test <- figS4a_data %>%
  filter(model %in% c("m2c", "m1c")) # change models accordingly
t.test(figS4a_test$bic[figS4a_test$model == "m1c"], figS4a_test$bic[figS4a_test$model == "m2c"], paired = T)
